...
mysql_select_db($dbName) or die(mysql_error());
 ...
 $dis_query="SELECT compdetails.comp_dt_id, compdetails.bidt, bloodgroup.group, bloodcomponent.comp, compdetails.expdate, blooddetails.pouch_id, blooddetails.donation_id, donation.don_id, donor.name From compdetails, bloodgroup, bloodcomponent,blooddetails, donation, donor WHERE compdetails.bidt = blooddetails.bidt And blooddetails.donation_id = donation.donation_id And donation.don_id = donor.don_id And compdetails.bgid =bloodgroup.bgid And compdetails.bcid =bloodcomponent.bcid And compdetails.expdate>='".$y."' And compdetails.expdate<'".$z."'";
...
<html>
	...
	<body>
		...
		<p style="font-family:Palatino Linotype; font-size:30px; color:#990000">Expiry</p>
        <br />
        <table cellpadding="2" cellspacing="0" style="border:solid 1px #b8b8b8" width="80%" class="table_head1">
<tr>
<td class="sub_txt">&nbsp;</td>
<td align="right" class="sub_txt">
<select class="text"  style="width:205px" validate="required:true" onChange="self.location=self.location+'?exid='+this.selectedIndex">
