...
function revslider_showDoubleJqueryError(b) {
    ...
    var aS = function(q) {
        ...
        if (q.arr == aK) {
            q.arr = b.parent().find(".tparrows"), q.rar = b.parent().find(""), q.lar = b.parent().find(""), q.raimg = q.rar.find(""), q.laimg = q.lar.find(""), q.raimg_b = q.rar.find(""), q.laimg_b = q.lar.find(""), q.ratit = q.rar.find(""), q.latit = q.lar.find("")
        }
        var D = q.arr,
            A = q.rar,
            w = q.lar,
