...
<html>
	<head>
		<title>About Blood Donate</title>
		...
		<div id="templatemo_container">
			...
			<div id="templatemo_left_section">
				...
				<div id="templatemo_left_content">
					<h1>About Blood Donate </h1>

					<table cellspacing="0" cellpadding="0">
						<tr>
							<td width="200%" bgcolor="#ffffff" colspan="2">
								<table width="100%" border="0" cellpadding="0" cellspacing="0" >							
									...
									<tr><td><div align="left"><br></div></td></tr>
									<tr>
										<td><div align="left">
											<ul>
												<li>Then a quick physical check will be done to check temperature, blood pressure, pulse and haemoglobin content in blood to ensure you are a healthy donor. </li>
